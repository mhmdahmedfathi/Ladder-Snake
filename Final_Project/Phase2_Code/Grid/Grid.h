...
public:
	...
	void SaveAll(ofstream& OutFile, type T);
	...
	bool Ice(Player* SpecialAttackCaller);
	bool Fire(Player* SpecialAttackCaller);
	bool Poison(Player* SpecialAttackCaller);
	void Lightning(Player* SpecialAttackCaller);
	void ClearAll(ifstream& OutFile);
