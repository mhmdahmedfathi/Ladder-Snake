...
void CardTen::ReadCardParameters(Grid * pGrid)
{
	...
	//a Static data member to make sure that the parameters of cardTen has been entered once
	...
	pOut->PrintMessage("New CardTen: Enter the Card Price to be paid by the cardOwner ...");
	...
	{
		pOut->PrintMessage("the Card Fees must be positive, please Enter again its Card Fees ..");
...
void CardTen::EditCardParameters(Grid * pGrid)
{
	...
	//Reading an Integer from the user using the Input class and set the Price and the Fees parameters with it
	pOut->PrintMessage("Editing CardTen: Enter the new Card Price to be paid by the cardOwner ...");
	int unValidatedPrice = pIn->GetInteger(pOut);
...
void CardTen::Apply(Grid* pGrid, Player* pPlayer)
{
	...
	if (!isBought)
	{
		...
		if ((pPlayer->GetWallet()) >= CardPrice)
		{
			...
			pOut->PrintMessage("You have reached CardTen, card's Price= " + to_string(CardPrice) + " Press 'Y' to buy it or 'N' to skip");
